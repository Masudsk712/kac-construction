...
const trustBadges = [
  { icon: <ShieldCheck size={20} />, label: "ISO Certified 9001:2015" },
  { icon: <Award size={20} />, label: "15+ Years of Excellence" },
];
        ...
        <Reveal>
          <div className="max-w-2xl">
            ...
            >
              ...
              <span className="text-[11px] sm:text-xs tracking-[4px] uppercase section-label">
                About Us
              </span>
            </motion.div>
            ...
            >
              <span className="accent-heading">
                A Decade Of<br />Dedication To<br />
              </span>
              <span className="text-slate-900 dark:text-white">Infrastructure</span>
            </motion.h2>
            ...
            >
              {trustBadges.map((badge, i) => (
                <div
                  key={i}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-400/20 bg-emerald-400/[0.04] text-[11px] sm:text-xs font-semibold text-emerald-700 dark:text-emerald-300"
                >
                  {badge.icon}
                  {badge.label}
                </div>
            ...
            >
              Established in <span className="text-slate-800 dark:text-white font-semibold">2010</span>,{" "}
              <span className="text-slate-900 dark:text-white font-semibold">Kuddus Ali Construction</span> has
              built a strong reputation in the electrical transmission line infrastructure sector across India.
            </motion.p>
            ...
            >
              Our mission: deliver reliable, high-quality construction, maintenance, and installation services for
              electrical transmission infrastructure — connecting communities and powering progress through
              innovation, safety, and execution excellence.
            </motion.p>
          ...
          <motion.div whileHover={{ y: -8, transition: sp.soft }} className="relative">
            ...
            <div className="relative h-[360px] sm:h-[520px] md:h-[620px] overflow-hidden rounded-[32px] border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-white/[0.04] backdrop-blur-2xl shadow-[0_20px_80px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
              <Image
                ...
                alt="Kuddus Ali Construction - Transmission Infrastructure"
                fill
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="flex-1">
                    <h3 className="text-xl sm:text-2xl font-black text-white leading-none mb-1">15+</h3>
                    <p className="text-[10px] sm:text-xs leading-[1.4] text-white/80">
                      Years of<br />Experience
                    </p>
                  </div>
                  <div className="w-px h-9 sm:h-10 bg-white/10" />
                  <div className="flex-1">
                    <h3 className="text-xl sm:text-2xl font-black text-white leading-none mb-1">765kV</h3>
                    <p className="text-[10px] sm:text-xs leading-[1.4] text-white/80">
                      Transmission<br />Expertise
                    </p>
                  </div>
                  <div className="w-px h-9 sm:h-10 bg-white/10" />
                  <div className="flex-1">
                    <h3 className="text-xl sm:text-2xl font-black text-white leading-none mb-1">50+</h3>
                    <p className="text-[10px] sm:text-xs leading-[1.4] text-white/80">
                      Active<br />Projects
                    </p>
                  </div>
